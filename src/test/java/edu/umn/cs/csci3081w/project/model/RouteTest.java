...
public class RouteTest {
  ...
  public void testUpdateRouteData() {
    ...
    assertEquals(stopsIn.get(0).getPassengers().size(),
        testRoute.getRouteData().getStops().get(0).getNumPeople());
    assertEquals(44.972392,
        testRoute.getRouteData().getStops().get(0).getPosition().getXcoordLoc());
    assertEquals(-93.243774,
        testRoute.getRouteData().getStops().get(0).getPosition().getYcoordLoc());
