...
public class RouteTest {
    ...
    public void testConstructorNormal() {
        ...
        assertEquals(0.008784, testRoute1.getNextStopDistance());
    ...
    public void testUpdate() {
        ...
        assertEquals(1, testRoute1.getStops().get(0).getPassengers().get(0).getDestination());
        ...
        assertEquals(2, testRoute1.getRouteData().getStops().size());
        assertEquals("testIn", testRoute1.getRouteData().getId());
        assertEquals(1, testRoute1.getStops().get(0).getPassengers().get(0).getTotalWait());
    /*try{
    ...
    */
     ...
     */
    @Test
    public void testReportWithOneStop() {
        try {
            Stop stop1 = new Stop(0, 44.972392, -93.243774);
            List<Stop> stopsIn = new ArrayList<Stop>();
            stopsIn.add(stop1);
        ...
        try {
            ...
            String strToCompare =
                    "####Route Info Start####" + System.lineSeparator()
                            ...
                            + "Wait at stop: 1" + System.lineSeparator()
    ...
    public void testUpdateRouteData() {
        ...
        Stop stop3 = new Stop(2, 44.975392, -93.226632);
        List<Stop> stopsIn = new ArrayList<Stop>();
        List<Stop> empty = new ArrayList<Stop>();
        stopsIn.add(stop1);
        stopsIn.add(stop2);
        stopsIn.add(stop3);
        List<Double> distancesIn = new ArrayList<Double>();
        ...
        assertEquals(empty, testRoute.getRouteData().getStops());
        ...
        assertEquals(stopsIn.get(0).getPassengers().size(), testRoute.getRouteData().getStops().get(0).getNumPeople());
        assertEquals(44.972392, testRoute.getRouteData().getStops().get(0).getPosition().getXcoordLoc());
        assertEquals(-93.243774, testRoute.getRouteData().getStops().get(0).getPosition().getYcoordLoc());
